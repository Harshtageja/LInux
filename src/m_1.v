...
module PG_4 (clk, RST,
	...
	PEn#(.ID (1), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance1 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance1_outport_0_dataValid));
	...
	PEn#(.ID (2), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance2 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance2_outport_0_dataValid));
	...
	PEn#(.ID (3), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance3 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance3_outport_0_dataValid));
	...
	PEn#(.ID (4), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance4 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance4_outport_0_dataValid));
	...
	PEn#(.ID (5), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance5 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance5_outport_0_dataValid));
	...
	PEn#(.ID (6), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance6 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance6_outport_0_dataValid));
	...
	PEn#(.ID (7), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance7 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance7_outport_0_dataValid));
	...
	PEn#(.ID (8), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance8 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance8_outport_0_dataValid));
	...
	PEn#(.ID (9), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance9 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance9_outport_0_dataValid));
	...
	PEn#(.ID (10), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance10 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance10_outport_0_dataValid));
	...
	PEn#(.ID (11), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance11 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance11_outport_0_dataValid));
	...
	PEn#(.ID (12), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance12 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance12_outport_0_dataValid));
	...
	PEn#(.ID (13), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance13 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance13_outport_0_dataValid));
	...
	PEn#(.ID (14), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance14 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance14_outport_0_dataValid));
	...
	PEn#(.ID (15), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance15 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance15_outport_0_dataValid));
	...
	PEn#(.ID (16), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance16 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance16_outport_0_dataValid));
	...
	PEn#(.ID (17), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance17 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance17_outport_0_dataValid));
	...
	PEn#(.ID (18), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance18 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance18_outport_0_dataValid));
	...
	PEn#(.ID (19), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance19 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance19_outport_0_dataValid));
	...
	PEn#(.ID (20), .MAX_ID (20), .ADDRWIDTH (5)) pen_instance20 (.CLK (clk), .RST (RST),
		...
		.outport_0_dataValid(pen_instance20_outport_0_dataValid));
	...
	// routes (0): {0: 0, 1: 1, 2: 4, 3: 2, 4: 2, 5: 8, 6: 1, 7: 7, 8: 1, 9: 2, 10: 3, 11: 2, 12: 4, 13: 3, 14: 3, 15: 4, 16: 4, 17: 6, 18: 1, 19: 3, 20: 5}
	...
	// routes (1): {0: 5, 1: 0, 2: 1, 3: 4, 4: 2, 5: 2, 6: 8, 7: 1, 8: 7, 9: 1, 10: 2, 11: 3, 12: 2, 13: 4, 14: 3, 15: 3, 16: 4, 17: 4, 18: 6, 19: 1, 20: 3}
	...
	// routes (2): {0: 3, 1: 5, 2: 0, 3: 1, 4: 4, 5: 2, 6: 2, 7: 8, 8: 1, 9: 7, 10: 1, 11: 2, 12: 3, 13: 2, 14: 4, 15: 3, 16: 3, 17: 4, 18: 4, 19: 6, 20: 1}
	...
	// routes (3): {0: 1, 1: 3, 2: 5, 3: 0, 4: 1, 5: 4, 6: 2, 7: 2, 8: 8, 9: 1, 10: 7, 11: 1, 12: 2, 13: 3, 14: 2, 15: 4, 16: 3, 17: 3, 18: 4, 19: 4, 20: 6}
	...
	// routes (4): {0: 6, 1: 1, 2: 3, 3: 5, 4: 0, 5: 1, 6: 4, 7: 2, 8: 2, 9: 8, 10: 1, 11: 7, 12: 1, 13: 2, 14: 3, 15: 2, 16: 4, 17: 3, 18: 3, 19: 4, 20: 4}
	...
	// routes (5): {0: 4, 1: 6, 2: 1, 3: 3, 4: 5, 5: 0, 6: 1, 7: 4, 8: 2, 9: 2, 10: 8, 11: 1, 12: 7, 13: 1, 14: 2, 15: 3, 16: 2, 17: 4, 18: 3, 19: 3, 20: 4}
	...
	// routes (6): {0: 4, 1: 4, 2: 6, 3: 1, 4: 3, 5: 5, 6: 0, 7: 1, 8: 4, 9: 2, 10: 2, 11: 8, 12: 1, 13: 7, 14: 1, 15: 2, 16: 3, 17: 2, 18: 4, 19: 3, 20: 3}
	...
	// routes (7): {0: 3, 1: 4, 2: 4, 3: 6, 4: 1, 5: 3, 6: 5, 7: 0, 8: 1, 9: 4, 10: 2, 11: 2, 12: 8, 13: 1, 14: 7, 15: 1, 16: 2, 17: 3, 18: 2, 19: 4, 20: 3}
	...
	// routes (8): {0: 3, 1: 3, 2: 4, 3: 4, 4: 6, 5: 1, 6: 3, 7: 5, 8: 0, 9: 1, 10: 4, 11: 2, 12: 2, 13: 8, 14: 1, 15: 7, 16: 1, 17: 2, 18: 3, 19: 2, 20: 4}
	...
	// routes (9): {0: 4, 1: 3, 2: 3, 3: 4, 4: 4, 5: 6, 6: 1, 7: 3, 8: 5, 9: 0, 10: 1, 11: 4, 12: 2, 13: 2, 14: 8, 15: 1, 16: 7, 17: 1, 18: 2, 19: 3, 20: 2}
	...
	// routes (10): {0: 2, 1: 4, 2: 3, 3: 3, 4: 4, 5: 4, 6: 6, 7: 1, 8: 3, 9: 5, 10: 0, 11: 1, 12: 4, 13: 2, 14: 2, 15: 8, 16: 1, 17: 7, 18: 1, 19: 2, 20: 3}
	...
	// routes (11): {0: 3, 1: 2, 2: 4, 3: 3, 4: 3, 5: 4, 6: 4, 7: 6, 8: 1, 9: 3, 10: 5, 11: 0, 12: 1, 13: 4, 14: 2, 15: 2, 16: 8, 17: 1, 18: 7, 19: 1, 20: 2}
	...
	// routes (12): {0: 2, 1: 3, 2: 2, 3: 4, 4: 3, 5: 3, 6: 4, 7: 4, 8: 6, 9: 1, 10: 3, 11: 5, 12: 0, 13: 1, 14: 4, 15: 2, 16: 2, 17: 8, 18: 1, 19: 7, 20: 1}
	...
	// routes (13): {0: 1, 1: 2, 2: 3, 3: 2, 4: 4, 5: 3, 6: 3, 7: 4, 8: 4, 9: 6, 10: 1, 11: 3, 12: 5, 13: 0, 14: 1, 15: 4, 16: 2, 17: 2, 18: 8, 19: 1, 20: 7}
	...
	// routes (14): {0: 7, 1: 1, 2: 2, 3: 3, 4: 2, 5: 4, 6: 3, 7: 3, 8: 4, 9: 4, 10: 6, 11: 1, 12: 3, 13: 5, 14: 0, 15: 1, 16: 4, 17: 2, 18: 2, 19: 8, 20: 1}
	...
	// routes (15): {0: 1, 1: 7, 2: 1, 3: 2, 4: 3, 5: 2, 6: 4, 7: 3, 8: 3, 9: 4, 10: 4, 11: 6, 12: 1, 13: 3, 14: 5, 15: 0, 16: 1, 17: 4, 18: 2, 19: 2, 20: 8}
	...
	// routes (16): {0: 8, 1: 1, 2: 7, 3: 1, 4: 2, 5: 3, 6: 2, 7: 4, 8: 3, 9: 3, 10: 4, 11: 4, 12: 6, 13: 1, 14: 3, 15: 5, 16: 0, 17: 1, 18: 4, 19: 2, 20: 2}
	...
	// routes (17): {0: 2, 1: 8, 2: 1, 3: 7, 4: 1, 5: 2, 6: 3, 7: 2, 8: 4, 9: 3, 10: 3, 11: 4, 12: 4, 13: 6, 14: 1, 15: 3, 16: 5, 17: 0, 18: 1, 19: 4, 20: 2}
	...
	// routes (18): {0: 2, 1: 2, 2: 8, 3: 1, 4: 7, 5: 1, 6: 2, 7: 3, 8: 2, 9: 4, 10: 3, 11: 3, 12: 4, 13: 4, 14: 6, 15: 1, 16: 3, 17: 5, 18: 0, 19: 1, 20: 4}
	...
	// routes (19): {0: 4, 1: 2, 2: 2, 3: 8, 4: 1, 5: 7, 6: 1, 7: 2, 8: 3, 9: 2, 10: 4, 11: 3, 12: 3, 13: 4, 14: 4, 15: 6, 16: 1, 17: 3, 18: 5, 19: 0, 20: 1}
	...
	// routes (20): {0: 1, 1: 4, 2: 2, 3: 2, 4: 8, 5: 1, 6: 7, 7: 1, 8: 2, 9: 3, 10: 2, 11: 4, 12: 3, 13: 3, 14: 4, 15: 4, 16: 6, 17: 1, 18: 3, 19: 5, 20: 0}
